...
INPUT=$SCRATCH/TGC_WES/0.RAWDATA
TRIMMED=$SCRATCH/TGC_WES/2.TRIMMED
OUTPUT=$SCRATCH/TGC_WES/1.QC/TRIMMED
...
java -jar /usr/product/bioinfo/SL_7.0/BIOINFORMATICS/TRIMMOMATIC/0.36/trimmomatic-0.36.jar PE -threads 48 -phred33 $INPUT/RAPiD-Genomics_F263_HEL_101203_${sample}_*_R1_001.fastq.gz $INPUT/RAPiD-Genomics_F263_HEL_101203_${sample}_*_R2_001.fastq.gz $TRIMMED/${sample}_R1_p.fastq.gz $TRIMMED/UNPAIRED/${sample}_R1_u.fastq.gz $TRIMMED/${sample}_R2_p.fastq.gz $TRIMMED/UNPAIRED/${sample}_R2_u.fastq.gz ILLUMINACLIP:/scratch/users/chano/TGC_WES/0.APPS/adapters.fa:2:30:10 HEADCROP:10 SLIDINGWINDOW:4:15 MINLEN:30

done

fastqc $TRIMMED/*_p.fastq.gz --outdir $OUTPUT --threads 48
# Run MultiQC
...
#-------------------------------------------------------------------------------
# Excute this script as sbatch $SCRATCH/TGC_WES/0.APPS/2.tgc.wes.trimm.and.fastqc.trimmed.sh
#-------------------------------------------------------------------------------
