...
# Samtools depth also works for the same purpose
# The code is from https://gettinggeneticsdone.blogspot.com/2014/03/visualize-coverage-exome-targeted-ngs-bedtools.html, with grep for "all"
