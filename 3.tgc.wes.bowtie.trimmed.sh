...
#SBATCH -n 96
#SBATCH -N 1
#SBATCH --job-name=WES.BT2
#SBATCH --output=BT2_%J_out.txt
#SBATCH --error=BT2_%J_err.txt
...
#-------------------------------------------------------------------------------
# Excute this script as sbatch $SCRATCH/TGC_WES/0.APPS/3.tgc.wes.bowtie.trimmed.sh
#-------------------------------------------------------------------------------
